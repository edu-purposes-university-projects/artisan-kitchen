...
<section class="bg-gradient-to-r from-amber-600 to-amber-700 text-white py-20 md:py-32">
    <div class="container mx-auto px-4 text-center">
        ...
        <a href="/menu" class="inline-block bg-white text-amber-600 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-amber-50 transition-colors duration-200 shadow-lg">
            View Our Menu
        </a>
    </div>
</section>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div class="bg-white p-8 rounded-lg shadow-md text-center hover:shadow-lg transition-shadow duration-200">
                ...
                <a href="/menu" class="inline-block mt-4 text-amber-600 font-semibold hover:text-amber-700">
                    View Menu →
                </a>
            </div>

                                        ...
                                        <tr>
                                            ...
                                            <td class="px-4 py-3 text-sm text-gray-700 max-w-xs">
                                                <div class="line-clamp-2">
                                                    <?php echo nl2br(htmlspecialchars((string) $order['customer_address'])); ?>
                                                </div>
                                            </td>
                                            <td class="px-4 py-3 text-sm text-center text-gray-700">
                                                <?php echo htmlspecialchars((string) $order['item_count']); ?>
                                            </td>
                                            ...
                                            <td class="px-4 py-3 text-xs text-center">
                                                <form action="/admin/orders/status" method="POST" class="inline-flex items-center space-x-2">
                                                    <input type="hidden" name="order_id" value="<?php echo htmlspecialchars((string) $order['order_id']); ?>">
                                                    <select name="status"
